...
export const Banner = () => {
    const [dataVideosMovie, setDataVideosMovies] = useState<fetchVideosMovie | null>(null)
    ...
    useEffect(() => {
        if (data) {
            ...
            if (peli?.id) {
                const urlVideosMovie = new URL(`https://api.themoviedb.org/3/movie/${peli.id}/videos`)
