            ...
            <div className='nav-right'>
                ...
                <div className='nav-config'>
                    ...
                    <ul>
                        ...
                        <hr />
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="PencilStandard" aria-hidden="true">
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="UserStandard" aria-hidden="true">
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="CircleQuestionMarkStandard" aria-hidden="true">
